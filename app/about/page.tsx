    ...
    <PageFrame>
      ...
      <main className="mx-auto max-w-4xl px-6 pb-20 pt-8 lg:px-10 lg:pt-10">
        <section className="space-y-6">
          <AnimatedPanel className="rounded-[2rem] border border-white/10 bg-shinkai-800/70 p-6 backdrop-blur-xl md:p-10">
            ...
            <h1 className="mt-4 text-3xl font-semibold leading-tight tracking-tight text-shinkai-100 md:text-4xl">
              言えなかった言葉のことを、
              <br />
              ずっと書いています。
            </h1>

            <div className="mt-6 space-y-5 text-sm leading-8 text-shinkai-200 md:text-base">
              <p>
          ...
          <AnimatedPanel className="rounded-[1.9rem] border border-white/10 bg-shinkai-800/70 p-6 backdrop-blur-xl md:p-8">
            <SectionHeader eyebrow="音づくりで大事にしていること" title="曲はいつも絵から始まります。" />
            <div className="space-y-4 text-sm leading-8 text-shinkai-200 md:text-base">
              <p>
