...
export const metadata: Metadata = {
  ...
  description: "提出前に、このままで大丈夫そうかをやさしく確認できます。音声ファイルをドラッグ＆ドロップするだけで、ノイズ・音割れ・サンプルレートを自動チェック。",
  openGraph: {
    title: "音声データチェック — 倫 / Rin music works",
    description: "提出前に、このままで大丈夫そうかをやさしく確認できます。音声ファイルをドラッグ＆ドロップするだけで自動チェック。",
